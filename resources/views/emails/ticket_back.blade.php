...
<div style="max-width: 600px; margin: 0 auto;">
  <table width="100%" border="0" align="center" cellpadding="10" cellspacing="0" bgcolor="#ffffff">
    <tbody>
      ...
      <tr>
        <td align="left" style="padding-left:25px; padding-right:25px;"><strong> Imprint SIGNS ha cargado un nuevo ticket</strong></p>
            ...
            <p></p>
            <p>Información completa ingresando al portal, luego a My profile y consultando la Orden de compra correspondiente.</p>
            <hr/>
        </td>
      </tr>
      <tr>
