    ...
    <tbody>
      ...
      <tr>
        <td align="left" style="padding-left:25px; padding-right:25px;">		  
          <p style="font-family: Arial, sans-serif; font-weight: normal; line-height: 19px; color: #1F1F1F; margin: 0px; font-size: 18px; padding-bottom: 10px; padding-top: 15px;"><strong>¡Se registro el usuario! {{$user->name}}, se requiere aprobación del registro.</strong><strong></strong></p>
          <p style="font-family: Arial, sans-serif; font-weight: normal; line-height: 19px; color: #cc2735; margin: 0px; font-size: 18px; padding-bottom: 10px; padding-top: 15px;"><strong>Empresa:{{$cliente->company}}</strong></p>
