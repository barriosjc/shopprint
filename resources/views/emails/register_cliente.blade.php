    ...
    <tbody>
      ...
      <tr>
        <td align="left" style="padding-left:25px; padding-right:25px;">		  
          <p style="font-family: Arial, sans-serif; font-weight: normal; line-height: 19px; color: #1F1F1F; margin: 0px; font-size: 18px; padding-bottom: 10px; padding-top: 15px;"><strong>¡hola! {{$user->name}}, Solo falta un paso mas.</strong><strong></strong></p>
          <p style="font-family: Arial, sans-serif; font-weight: normal; line-height: 19px; color: #cc2735; margin: 0px; font-size: 18px; padding-bottom: 10px; padding-top: 15px;"><strong>Su registro se ha ingresado con Exito, solo falta la aprobación de Imprint SIGNS</strong></p>
          <p style="font-family: Arial, sans-serif; font-weight: normal; line-height: 19px; color: #cc2735; margin: 0px; font-size: 18px; padding-bottom: 10px; padding-top: 15px;"><strong>A la brevedad le vamos a enviar un nuevo email con novedades.</p>
          <hr/>
        </td>
      </tr>
      <tr>
