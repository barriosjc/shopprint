            ...
            <div class="row pb-2">
                <div class="col-md-6 text-center text-md-start mb-4">
                    <div class="text-nowrap mb-4"><a class="d-inline-block align-middle mt-n1 me-3"
                            href="#"><img class="d-block" src="img/logo-footer-imprint-signs.png"
                                width="140" alt="Imprint Signs"></a>
                    </div>
                ...
                <div class="col-md-6 text-center text-md-end mb-4">
                    <div class="mb-3"><a class="btn-social bs-light bs-twitter ms-2 mb-2" href="#"><i
                        ...
                        src={{ asset("img/cards-alt.png") }} width="187" alt="Payment methods">
                </div>
            </div>
            <div class="pb-4 fs-xs text-light opacity-50 text-center text-md-start">© Imprint Signs. All rights
                reserved.</div>
        </div>
    </div>
</footer>